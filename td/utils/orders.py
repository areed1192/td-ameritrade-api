...
#     def _grab_order(self) -> dict:
#         """
#         ### Overview
#         ----
#         Grabs all the info passed through to the order object,
#         creates an Ordered Dicitonary, checks for OrderLegCollection
#         and grabs their values, and checks for ChildOrderStartegies
