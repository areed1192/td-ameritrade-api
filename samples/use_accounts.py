...
pprint(accounts_service.get_accounts(account_id=account_number, include_positions=True))
...
pprint(
    accounts_service.get_transactions(
        account_id=account_number, transaction_type=TransactionTypes.MARGIN_CALL
    )
)
